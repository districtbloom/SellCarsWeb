...
- Interactions appear above their world objects. Use **E**, or the existing guide button to walk to the current objective.
...
- The parts laptop has a green, black-outlined **SELL CARS PART** label with its current payout underneath. **E** starts five seconds of rapid hand typing, with the rest of the body still and a progress bar above the player. Money arrives after the animation. **Esc** pauses it; interact again to resume. Laptop upgrades remain available through the phone's Home tab.
